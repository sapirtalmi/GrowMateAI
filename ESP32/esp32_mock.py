...
def generate_sensor_data():
    return {
        ...
        "SoilMoisture": random.randint(1, 4)
    }

def send_data(data, endpoint='http://localhost:7071/api/SignalProcessing'):
    print("Sending data...")
    if endpoint:
        try:
...
def run_manual(endpoint='http://localhost:7071/api/SignalProcessing'):
